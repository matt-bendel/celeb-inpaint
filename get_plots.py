        ...
        with torch.no_grad():
            ...
            for j in range(y.size(0)):
                ...
                if total in ethnicity_div:
                    ...
                    plt.savefig(f'neurips_plots/all/original_{total}.png', bbox_inches='tight', dpi=300)
                    plt.close(fig)

                    fig = plt.figure()
                    plt.axis('off')
                    plt.imshow(y_unnorm[j, :, :, :].cpu().numpy().transpose(1, 2, 0))
                    plt.savefig(f'neurips_plots/all/masked_{total}.png', bbox_inches='tight', dpi=300)
                    plt.close(fig)
                    ...
                    plt.savefig(f'neurips_plots/test_ours/5_recons_comodgan_{total}_1.png',bbox_inches='tight', dpi=300)
                    plt.close(fig)
                    ...
                    for r in range(5):
                        ...
                        # if r == 2:
                        #     ax.set_xlabel('CoModGAN',fontweight='bold')
                        ax.imshow(gens_comod_psi_1[j, r+5, :, :, :].cpu().numpy().transpose(1, 2, 0))

                    plt.savefig(f'neurips_plots/test_ours/5_recons_comodgan_{total}_2.png', bbox_inches='tight', dpi=300)
                    plt.close(fig)
                    ...
                    for r in range(5):
                        ...
                        # if r == 2:
                        #     ax.set_xlabel('CoModGAN',fontweight='bold')
                        ax.imshow(gens_comod_psi_1[j, r+10, :, :, :].cpu().numpy().transpose(1, 2, 0))

                    plt.savefig(f'neurips_plots/test_ours/5_recons_comodgan_{total}_3.png', bbox_inches='tight', dpi=300)
                    plt.close(fig)
                    ...
                    for r in range(5):
                        ...
                        # if r == 2:
                        #     ax.set_xlabel('CoModGAN',fontweight='bold')
                        ax.imshow(gens_comod_psi_1[j, r+15, :, :, :].cpu().numpy().transpose(1, 2, 0))
                    ...
                    for r in range(5):
                        ...
                        # if r == 2:
                        #     ax.set_xlabel('CoModGAN',fontweight='bold')
                        ax.imshow(gens_comod_psi_1[j, r + 24, :, :, :].cpu().numpy().transpose(1, 2, 0))
