...
class CFIDMetric:
    ...
    def get_cfid_torch(self, resample=True):
        ...
        c_y_true_given_x_true = torch.matmul(no_m_y_true.t(), no_m_y_true) - y_true_w_v_t_v
        c_y_predict_given_x_true = torch.matmul(no_m_y_pred.t(), no_m_y_pred) - y_pred_w_v_t_v
